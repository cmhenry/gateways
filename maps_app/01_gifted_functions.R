...
gg_state_plot<-function(df_list,var,groupvar,axis_label, year){
  ## gg state_plot:
  ## takes options
  ## df: data frame name
  ...
  gg<-gg+theme_minimal()
  gg<-gg+theme(axis.text.y=element_text(size=7,angle=0))
...
map_gen<-function(geo_df_list,var,legend_label, year){
